...
if(isset($_GET['edit_id']) && !empty($_GET['edit_id']))
{
    ...
    $stmt_edit = "SELECT date_of_birth, phone_number, hostel_address, name_of_sponsors,
 phone_number_of_sponsors, gender,
 department, first_name, last_name, user_email, user_name, user_pass, avatar FROM `100` WHERE user_name ='$user_name'";
    $edit_row = mysqli_fetch_assoc(mysqli_query($con, $stmt_edit));
