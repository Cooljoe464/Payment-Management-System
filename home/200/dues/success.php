...
$query = "SELECT user_email, department, user_name ,first_name, phone_number FROM `100` WHERE user_name='{$_SESSION['user']}'";
...
$actual_user_dept= $result_array['department'];
...
<table class="table table-responsive table-bordered ">
    ...
    <tr>
        ...
        <td class="size"><?php echo $actual_user_dept; ?></td>
    </tr>
</table>
</div>
