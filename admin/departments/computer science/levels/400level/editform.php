...
<?php
 ...
 department, first_name, last_name, user_email, user_name, user_pass, avatar FROM `400` WHERE user_id =:uid');
	...
	if(isset($_POST['btn_save_updates']))
	{
        ...
        $userName = htmlentities(strtoupper($_POST['user_name']));
		...
		if($avatar)
		{
			$upload_dir = '../../../department/computersci/students/level/400lvl/image/'; // upload directory
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE `400` SET date_of_birth=:dob, phone_number=:pn, hostel_address=:ha, name_of_sponsors=:nos,
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<table class="table table-bordered table-responsive">
        ...
        <td>
        	<p><img src="../../../department/computersci/students/level/400lvl/image/<?php echo $edit_row['avatar']; ?>" height="150" width="150" /></p>
