...
{
    $id = $_GET['edit_id'];
    $stmt_edit = $DB_con->prepare('SELECT dateofbirth, phonenumber, hostel, sponsor,
 sponsorphonenumber, gender, first_name, last_name, user_email, user_name, password, avatar FROM `users` WHERE id =:uid');
...
if(isset($_POST['btn_save_updates']))
{
    ...
    if($avatar)
    {
        $upload_dir = '../../../students/level/100lvl/image/'; // upload directory
    ...
    if(!isset($errMSG))
    {
        $stmt = $DB_con->prepare('UPDATE `users` SET dateofbirth=:dob, phonenumber=:pn, hostel=:ha, sponsor=:nos,
 sponsorphonenumber:pnos, gender=:ge,
 first_name=:fn, last_name:ln, user_email=:ue, user_name=:un, avatar:av WHERE id=:uid');
    ...
    <form method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <table class="table table-bordered table-responsive">
            ...
            <tr>
                ...
                <td>
                    <p><img src="../../../../../image/<?php echo $edit_row['avatar']; ?>" height="150" width="150" /></p>
