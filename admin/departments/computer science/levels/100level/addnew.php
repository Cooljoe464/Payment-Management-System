...
<?php
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO `users`(dateofbirth, phonenumber, hostel, sponsor,
 sponsorphonenumber, gender ,first_name, last_name, user_email, user_name, password, avatar)
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td><select title="" class="form-control" required autofocus name="txt_gender">
